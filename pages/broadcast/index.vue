<template>
  <div class="flex flex-col md:flex-row gap-5">
    <Sidebar class="md:w-1/4 shrink-0" v-model="projectId" title="赛事播报" :list="projectListData"></Sidebar>
    <div class="grow">
      <div v-if="!!list.length" class="divide-y divide-gray-200 divide-dashed">
        <div class="p-2 py-5 flex gap-5 items-center cursor-pointer hover:bg-gray-50 group"
...
const goDetail = (item) => {
  jumpPath(`/broadcast/${item.broadcastId}`)
}
</script>
