...
export default {
  ...
  getProjectList: (params = {}) => fetchUtils.get('/system/project/list', {pageNum: 1, pageSize: 40, ...params}),
  getProjectDetail: (id) => fetchUtils.get(`/system/project/${id}`),
  getContestList: (params = {}) => fetchUtils.get('/system/contest/list', {pageNum: 1, pageSize: 40, ...params}),
  getContestDetail: (id) => fetchUtils.get(`/system/contest/${id}`),
  getNotificationList: (params = {}) => fetchUtils.get('/system/notification/list', {pageNum: 1, pageSize: 40, ...params}),
  getNotificationDetail: (id) => fetchUtils.get(`/system/notification/${id}`),
  getBroadcastList: (params = {}) => fetchUtils.get('/system/broadcast/list', {pageNum: 1, pageSize: 40, ...params}),
